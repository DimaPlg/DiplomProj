...
object SqlTable {
    ...
    const val admin = "CRETE TABLE  ADMIN(ID INTEGER PRIMARY KEY AUTOINCREMENT,USER_NAME TEXT DEFAULT ''," +
    ...
    const val fee = "CREATE TABLE FEE(ID INTEGER PRIMARY KEY AUTOINCREMENT,ONE_MONTH TEXT DEFAULT '',TWO_MONTH TEXT DEFAULT '',THREE_MONTH TEXT DEFAULT '',"+
          "SIX_MONTH TEXT DEFAULT '',ONE_YEAR TEXT DEFAULT '')"
}